...
* `self.WP_TOLERANCE` - how close should quad be to consider WP reached
* `self.TAKEOFF_ALTITUDE` - altitude to reach while taking off
* `self.HEADING_ALONG_ROUTE` - if quad should adjust yaw along route segments
